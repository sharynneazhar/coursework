 ...
 */
void dobreak() { fprintf(stderr, "sem: dobreak not implemented\n"); }

/*
 * docontinue - continue statement
 */
void docontinue() { fprintf(stderr, "sem: docontinue not implemented\n"); }
 ...
 */
void dogoto(char *id) { fprintf(stderr, "sem: dogoto not implemented\n"); }
 ...
 */
void ftail() { fprintf(stderr, "sem: ftail not implemented\n"); }
 ...
 */
void labeldcl(char *id) { fprintf(stderr, "sem: labeldcl not implemented\n"); }
...
struct sem_rec *set(char *op, struct sem_rec *x, struct sem_rec *y) {
  ...
  return (node(currtemp(), (x->s_mode & ~(T_ARRAY)), (struct sem_rec *)NULL,
               (struct sem_rec *)NULL));
}
